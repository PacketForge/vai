...
ALL_RECIPIENTS = [
    ...
    "jhenderson@merit-group.us",
    "chris.sparks@merit-group.us",
    "trousdale-tcs-MerIT-VAI-ALERTS@merit-cloud.com",
    "andyoverman@tcschools.org",
]

SENDER_EMAIL = "trousdale-tcs-MerIT-VAI-ALERTS@merit-cloud.com"
...
WEEKLY_DIGEST_FILE      = "/var/ossec/logs/tcs_weekly_digest.json"
WEEKLY_DIGEST_SENT_FILE = "/var/ossec/logs/tcs_digest_sent.txt"
digest_lock = threading.Lock()

# --- Enable / Disable / Queue ---
DISABLE_FLAG_FILE = "/var/ossec/logs/tcs_mailer_disabled"
ALERT_QUEUE_FILE  = "/var/ossec/logs/tcs_alert_queue.json"
PID_FILE          = "/var/ossec/logs/tcs_mailer.pid"
